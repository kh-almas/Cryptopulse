...
const getDesignTokens = (mode) => ({
    palette: {
        ...
        darkNavyBlue: {
            50: darkNavyBlue[50],
            100: darkNavyBlue[100],
            200: darkNavyBlue[200],
            300: darkNavyBlue[300],
            400: darkNavyBlue[400],
            500: darkNavyBlue[500],
            600: darkNavyBlue[600],
            700: darkNavyBlue[700],
            800: darkNavyBlue[800],
            900: darkNavyBlue[900],
        },
        divider: mode === 'dark' ? alpha(gray[600], 0.3) : alpha(gray[300], 0.5),
        background: {
            default: '#fff',
            paper: gray[50],
            ...(mode === 'dark' && { default: darkNavyBlue[900], paper: darkNavyBlue[800] }),
        },
        text: {
            primary: gray[800],
            secondary: gray[600],
